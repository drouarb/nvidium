...
public class RegionManager {
    ...
    public RegionManager(RenderDevice device, int maxRegions, int maxSections, UploadingBufferStream uploadStream, Consumer<Integer> regionUploaded) {
        ...
        this.device = device;
        this.regionBuffer = new DeviceOnlyMappedBuffer((long) maxRegions * META_SIZE, GL_SHADER_STORAGE_BUFFER, "RegionBuffer");
        this.sectionBuffer = new DeviceOnlyMappedBuffer((long) maxSections * SectionManager.SECTION_SIZE, GL_SHADER_STORAGE_BUFFER, "SectionBuffer");
